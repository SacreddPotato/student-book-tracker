...
export const ar = {
  ...
  common: {
    ...
    cancel: "إلغاء", delete: "حذف", save: "حفظ", saving: "جارٍ الحفظ…", confirm: "تأكيد",
  ...
  students: {
    ...
    add: "إضافة طالب", edit: "تعديل الطالب", delete: "حذف الطالب", select: "اختيار الطالب",
    deleteTitle: "حذف الطالب", deleteDescription: "سيتم حذف الطالب من العام الدراسي الحالي مع الاحتفاظ بالسجلات التاريخية.",
  ...
  errors: {
    ...
    reverse: "تعذر عكس هذه العملية.", export: "تعذر إنشاء ملف التصدير.", delete: "تعذر حذف هذا السجل.",
  },
